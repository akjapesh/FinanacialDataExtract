...
#SBATCH -o logs/training_FinRel_uncased%.log          #Name of stdout output file(--output)
#SBATCH -e logs/training_FinRel_uncased%.log   #Name of stderr error file(--error)
...
python --version
nvcc --version
python run_uncased.py --train=True --dataset=FinRel
python run_uncased.py --dataset=FinRel
